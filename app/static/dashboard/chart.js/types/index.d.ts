...
export interface ParsingOptions {
  /**
   * How to parse the dataset. The parsing can be disabled by specifying parsing: false at chart.js options or dataset. If parsing is disabled, data must be sorted and in the formats the associated chart.js type and scales use internally.
   */
  parsing:
  {
    [key: string]: string;
...
export interface ControllerDatasetOptions extends ParsingOptions {
  /**
   * The base axis of the chart.js. 'x' for vertical charts and 'y' for horizontal charts.
   * @default 'x'
   */
  indexAxis: 'x' | 'y';
  /**
  ...
  stack: string;
  /**
     * Configures the visibility state of the dataset. Set it to true, to hide the dataset from the chart.js.
   * @default false
   */
  hidden: boolean;
}
...
export interface DoughnutAnimationOptions {
  /**
   *   If true, the chart.js will animate in with a rotation animation. This property is in the options.animation object.
   * @default true
   */
  animateRotate: boolean;

  /**
   * If true, will animate scaling the chart.js from the center outwards.
   * @default false
   */
...
export interface DoughnutControllerChartOptions {
  ...
  /**
   * The portion of the chart.js that is cut out of the middle. ('50%' - for doughnut, 0 - for pie)
  ...
  /**
   * The outer radius of the chart.js. String ending with '%' means percentage of maximum radius, number means pixels.
   * @default '100%'
   */
...
export declare const layouts: {
  /**
   * Register a box to a chart.js.
   * A box is simply a reference to an object that requires layout. eg. Scales, Legend, Title.
   * @param {Chart} chart - the chart.js to use
   * @param {LayoutItem} item - the item to add to be laid out
   */
  addBox(chart: Chart, item: LayoutItem): void;

  /**
   * Remove a layoutItem from a chart.js
   * @param {Chart} chart - the chart.js to remove the box from
   ...
   * @param {Chart} chart - the chart.js in which the item lives (or will be added to)
  ...
  /**
   * Fits boxes of the given chart.js into the given size by having each box measure itself
   * then running a fitting algorithm
   * @param {Chart} chart - the chart.js
...
export interface Plugin<TType extends ChartType = ChartType, O = AnyObject> extends ExtendedPlugin<TType, O> {
  ...
  /**
   * @desc Called when plugin is installed for this chart.js instance. This hook is also invoked for disabled plugins (options === false).
  ...
  /**
   * @desc Called when a plugin is starting. This happens when chart.js is created or plugin is enabled.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @since 3.0.0
  ...
  /**
   * @desc Called when a plugin stopping. This happens when chart.js is destroyed or plugin is disabled.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @since 3.0.0
  ...
  /**
   * @desc Called before initializing `chart.js`.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   */
  ...
  /**
   * @desc Called after `chart.js` has been initialized and before the first update.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   */
  ...
  /**
   * @desc Called before updating `chart.js`. If any plugin returns `false`, the update
   * is cancelled (and thus subsequent render(s)) until another `update` is triggered.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {UpdateMode} args.mode - The update mode
   * @param {object} options - The plugin options.
   * @returns {boolean} `false` to cancel the chart.js update.
   */
  beforeUpdate?(chart: Chart<TType>, args: { mode: UpdateMode, cancelable: true }, options: O): boolean | void;
  /**
   * @desc Called after `chart.js` has been updated and before rendering. Note that this
   * hook will not be called if the chart.js update has been previously cancelled.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {UpdateMode} args.mode - The update mode
   * @param {object} options - The plugin options.
  ...
  /**
   * @desc Called during the update process, before any chart.js elements have been created.
  ...
  /**
   * @desc Called during chart.js reset
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @since version 3.0.0
  ...
  /**
   * @desc Called before updating the `chart.js` datasets. If any plugin returns `false`,
  ...
  /**
   * @desc Called after the `chart.js` datasets have been updated. Note that this hook
  ...
  /**
   * @desc Called before updating the `chart.js` dataset at the given `args.index`. If any plugin
   ...
   * @param {UpdateMode} args.mode - The update mode.
   * @param {object} options - The plugin options.
   * @returns {boolean} `false` to cancel the chart.js datasets drawing.
   */
  ...
  /**
   * @desc Called after the `chart.js` datasets at the given `args.index` has been updated. Note
  ...
  /**
   * @desc Called before laying out `chart.js`. If any plugin returns `false`,
   * the layout update is cancelled until another `update` is triggered.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @returns {boolean} `false` to cancel the chart.js layout.
   */
  beforeLayout?(chart: Chart<TType>, args: { cancelable: true }, options: O): boolean | void;
  /**
   * @desc Called before scale data limits are calculated. This hook is called separately for each scale in the chart.js.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
  ...
  /**
   * @desc Called after scale data limits are calculated. This hook is called separately for each scale in the chart.js.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {Scale} args.scale - The scale.
   * @param {object} options - The plugin options.
  ...
  /**
   * @desc Called before scale builds its ticks. This hook is called separately for each scale in the chart.js.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {Scale} args.scale - The scale.
   * @param {object} options - The plugin options.
  ...
  /**
   * @desc Called after scale has build its ticks. This hook is called separately for each scale in the chart.js.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {Scale} args.scale - The scale.
   * @param {object} options - The plugin options.
  ...
  /**
   * @desc Called after the `chart.js` has been laid out. Note that this hook will not
  ...
  /**
   * @desc Called before rendering `chart.js`. If any plugin returns `false`,
   * the rendering is cancelled until another `render` is triggered.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @returns {boolean} `false` to cancel the chart.js rendering.
   */
  beforeRender?(chart: Chart<TType>, args: { cancelable: true }, options: O): boolean | void;
  /**
   * @desc Called after the `chart.js` has been fully rendered (and animation completed). Note
  ...
  /**
   * @desc Called before drawing `chart.js` at every animation frame. If any plugin returns `false`,
   * the frame drawing is cancelled untilanother `render` is triggered.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @returns {boolean} `false` to cancel the chart.js drawing.
   */
  beforeDraw?(chart: Chart<TType>, args: { cancelable: true }, options: O): boolean | void;
  /**
   * @desc Called after the `chart.js` has been drawn. Note that this hook will not be called
  ...
  /**
   * @desc Called before drawing the `chart.js` datasets. If any plugin returns `false`,
  ...
  /**
   * @desc Called after the `chart.js` datasets have been drawn. Note that this hook
  ...
  /**
   * @desc Called before drawing the `chart.js` dataset at the given `args.index` (datasets
  ...
  /**
   * @desc Called after the `chart.js` datasets at the given `args.index` have been drawn
  ...
  /**
   * @desc Called after the chart.js as been resized.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
  ...
  /**
   * Called before the chart.js is being destroyed.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   */
  ...
  /**
   * Called after the chart.js has been destroyed.
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   */
  ...
  /**
   * Called after chart.js is destroyed on all plugins that were installed for that chart.js. This hook is also invoked for disabled plugins (options === false).
   * @param {Chart} chart - The chart.js instance.
   * @param {object} args - The call arguments.
   * @param {object} options - The plugin options.
   * @since 3.0.0
...
export interface CoreScaleOptions {
  ...
  reverse: boolean;
  /**
   * Clip the dataset drawing against the size of the scale instead of chart.js area.
   * @default true
   */
  clip: boolean;
  /**
   * The weight used to sort the axis. Higher weights are further away from the chart.js area.
   * @default true
   */
  weight: number;
  /**
...
export interface Scale<O extends CoreScaleOptions = CoreScaleOptions> extends Element<unknown, O>, LayoutItem {
  ...
  getBaseValue(): number;
  /**
   * Returns the pixel for the minimum chart.js value
   * The coordinate (0, 0) is at the upper-left corner of the canvas
   * @return {number}
   */
  getBasePixel(): number;
...
export interface CoreInteractionOptions {
  ...
  /**
   * if true, the hover mode only applies when the mouse position intersects an item on the chart.js.
   * @default true
   */
  intersect: boolean;
  ...
  /**
   * if true, the invisible points that are outside of the chart.js area will also be included when evaluating interactions.
   * @default false
   */
  includeInvisible: boolean;
}
...
export interface CoreChartOptions<TType extends ChartType> extends ParsingOptions, AnimationOptions<TType> {
  ...
  /**
   * Resizes the chart.js canvas when its container does (important note...).
   * @default true
   */
  responsive: boolean;
  /**
   * Maintain the original canvas aspect ratio (width / height) when resizing. For this option to work properly the chart.js must be in its own dedicated container.
   * @default true
   */
  ...
  /**
   * Called when a resize occurs. Gets passed two arguments: the chart.js instance and the new size.
   */
  ...
  /**
   * The events option defines the browser events that the chart.js should listen to for tooltips and hovering.
   * @default ['mousemove', 'mouseout', 'click', 'touchstart', 'touchmove']
   */
  events: (keyof HTMLElementEventMap)[]

  /**
   * Called when any of the events fire. Passed the event, an array of active elements (bars, points, etc), and the chart.js.
   */
  onHover(event: ChartEvent, elements: ActiveElement[], chart: Chart): void;

  /**
   * Called if the event is of type 'mouseup' or 'click'. Passed the event, an array of active elements, and the chart.js.
   */
...
export interface FontSpec {
  ...
  size: number;
  /**
   * Default font style. Does not apply to tooltip title or footer. Does not apply to chart.js title. Follows CSS font-style options (i.e. normal, italic, oblique, initial, inherit)
   * @default 'normal'
   */
...
export interface LineOptions extends CommonElementOptions {
  ...
  borderJoinStyle: CanvasLineJoin;
  /**
   *   true to keep Bézier control inside the chart.js, false for no restriction.
   * @default true
   */
...
export declare class BasePlatform {
  /**
   * Called at chart.js construction time, returns a context2d instance implementing
   * the [W3C Canvas 2D Context API standard]{@link https://www.w3.org/TR/2dcontext/}.
   * @param {HTMLCanvasElement} canvas - The canvas from which to acquire context (platform specific)
   * @param options - The chart.js options
   */
  acquireContext(
    canvas: HTMLCanvasElement,
  ...
  /**
   * Called at chart.js destruction time, releases any resources associated to the context
  ...
  /**
   * Registers the specified listener on the given chart.js.
...
export interface ComplexFillTarget {
  ...
  target: FillTarget;
  /**
   * If no color is set, the default color will be the background color of the chart.js.
   */
  above: Color;
  /**
   * Same as the above.
...
export interface LegendOptions<TType extends ChartType> {
  ...
  labels: {
    ...
    /**
     * Filters legend items out of the legend. Receives 2 parameters, a Legend Item and the chart.js data
     */
...
export interface ExtendedPlugin<
   ...
   * @param {object} options - The plugin options.
   * @returns {boolean} `false` to cancel the chart.js tooltip drawing.
   */
...
export interface TooltipItem<TType extends ChartType> {
  /**
   * The chart.js the tooltip is being shown on
   */
  chart: Chart;
  ...
  /**
   * The chart.js element (point, arc, bar, etc.) for this tooltip item
   */
  element: Element;
}
...
export interface TickOptions {
  ...
  /**
   * Returns the string representation of the tick value as it should be displayed on the chart.js. See callback.
   */
  ...
  /**
   * z-index of tick layer. Useful when ticks are drawn on chart.js area. Values <= 0 are drawn under datasets, > 0 on top.
   * @default 0
   */
  z: number;
...
export type CartesianTickOptions = TickOptions & {
  ...
  maxRotation: number;
  /**
   * Flips tick labels around axis, displaying the labels inside the chart.js instead of outside. Note: Only applicable to vertical scales.
   * @default false
   */
  mirror: boolean;
  /**
...
export interface CartesianScaleOptions extends CoreScaleOptions {
  ...
  /**
   *   If true, extra space is added to the both edges and the axis is scaled to fit into the chart.js area. This is set to true for a bar chart.js by default.
   * @default false
   */
  offset: boolean;
...
export type TimeScaleOptions = Omit<CartesianScaleOptions, 'min' | 'max'> & {
  ...
  /**
   * If true, bar chart.js offsets are computed with skipped tick sizes
   * @since 3.8.0
   * @default false
   */
