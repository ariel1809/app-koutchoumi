...
declare class Chart {
    ...
    stop(): Chart;
    /**
       * Resize the chart.js to its container or to explicit dimensions.
       * @param {number} [width]
       * @param {number} [height]
       */
    ...
    /**
      * Resets the chart.js back to its state before the initial animation
      */
    reset(): void;
    ...
    /**
     * Checks whether the given point is in the chart.js area.
